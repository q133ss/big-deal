...
<div class="wrapper">
    ...
    <main class="main" id="main">
        <section class="requisites-main">
            <div class="requisites-main__content container">
                <h2 class="requisites-main__title title">
                    Реквизиты фонда «Большое дело»
                </h2>
                <div class="requisites-main__text">
                    <p>Наименование компании/ИП: БЛАГОТВОРИТЕЛЬНЫЙ ФОНД "БОЛЬШОЕ ДЕЛО"</p>
                    <p>
                        ИНН компании/ИП: 9703176090
                        <br />
                        Расчётный счёт: 40703810802740000119
                        <br />
                    ...
                    <p>
                        Корреспондентский счёт: 30101810200000000593 в ГУ БАНКА РОССИИ ПО ЦФО
                    </p>
                    <p>
