...
<div class="wrapper">
    ...
    <main class="main" id="main">
        <section class="fee-initial">
            <div class="fee-initial__content container">
                <div class="fees-item">
    ...
    <path d="M1 1.14545H17M17 1.14545V16.8545M17 1.14545L1 16.8545" stroke="currentColor" stroke-width="2"/>
                    ...
                    <div class="fees-item__buttons fees-item__buttons-single fees-item__buttons-mobile">
                        <button class="button" data-modal-toggle="modal-donate">
                    <span class="button-arrow">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
    <path d="M1 1.14545H17M17 1.14545V16.8545M17 1.14545L1 16.8545" stroke="currentColor" stroke-width="2"/>
        ...
        <section class="fee-gallery">
            <div class="fee-gallery__content container">
                <h2 class="fee-gallery__title title">
                    Уже открыли свои двери <br />
                    для школьников
                </h2>
                <div class="fee-gallery__wrapper">
                    <button class="fee-gallery__button-prev slider-button slider-button__prev">
                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12.079 7.5L6.287 13.292L7 14L14 7L7 0L6.287 0.708L12.079 6.5H0V7.5H12.079Z" fill="#2F83E5"/>
                        </svg>
                    </button>
                    <button class="fee-gallery__button-next slider-button slider-button__next">
                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12.079 7.5L6.287 13.292L7 14L14 7L7 0L6.287 0.708L12.079 6.5H0V7.5H12.079Z" fill="#2F83E5"/>
                        </svg>
                    </button>
                    <div class="fee-gallery__slider-wrapper swiper">
                        <div class="fee-gallery__slider swiper-wrapper">
                            <?php
                            ...
                            <img
                                src="<?php echo $photo; ?>"
                                alt="Картинка <?php echo $i; ?>"
                                class="fee-gallery__slider-item swiper-slide"
                            />
                            <?php endforeach; ?>
                        </div>
                    </div>
                    <div class="fee-gallery__pagination slider-pagination"></div>
                </div>
            </div>
        </section>
        <section class="news">
